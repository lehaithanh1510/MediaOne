...
public class BillSoldDetail extends javax.swing.JPanel {
    ...
    private void addProductBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addProductBtnActionPerformed
        try {
            ...
            BillItem billItem = new BillItem(txtID.getText(), txtName.getText(), Integer.parseInt(txtQuantity.getText()), Double.parseDouble(txtUnitPrice.getText()));
    ...
    private void saveBillBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveBillBtnMouseClicked
        ...
        editBillSold.setCustomer(new Customer(txtCustomerofName.getText(), txtAddress.getText(), txtPhoneNumber.getText()));
