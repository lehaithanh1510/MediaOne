package mediaone.Component.ProductComponent;
...
public class ProductCard extends javax.swing.JPanel {
    ...
    public ProductCard(Product product, HomePage homePage) {
        ...
        Image imageFilm = (new ImageIcon(directory.getAbsolutePath() + "\\src\\main\\java\\image\\filmCD.png")).getImage().getScaledInstance(100, 100, java.awt.Image.SCALE_SMOOTH);
        Image imageBook = (new ImageIcon(directory.getAbsolutePath() + "\\src\\main\\java\\image\\book.png")).getImage().getScaledInstance(100, 100, java.awt.Image.SCALE_SMOOTH);
        Image imageMusic = (new ImageIcon(directory.getAbsolutePath() + "\\src\\main\\java\\image\\musicCd.png")).getImage().getScaledInstance(100, 100, java.awt.Image.SCALE_SMOOTH);
    ...
    private void initImageIcon() {
        File directory = new File("");
        deleteBtn.setIcon(new javax.swing.ImageIcon(directory.getAbsolutePath() + "\\src\\main\\java\\image\\delete.png")); // NOI18N
        editBtn.setIcon(new javax.swing.ImageIcon(directory.getAbsolutePath() + "\\src\\main\\java\\image\\pencil.png")); // NOI18N
    }
    ...
    private void initComponents() {
        ...
        deleteBtn.setIcon(new javax.swing.ImageIcon("C:\\Users\\MY LAPTOP\\OneDrive\\Documents\\NetBeansProjects\\MediaOne\\src\\main\\java\\image\\delete.png")); // NOI18N
        ...
        editBtn.setIcon(new javax.swing.ImageIcon("C:\\Users\\MY LAPTOP\\OneDrive\\Documents\\NetBeansProjects\\MediaOne\\src\\main\\java\\image\\pencil.png")); // NOI18N
